...
A self-hosted runner is a server you manage that runs GitHub Actions workflows, instead of using GitHub's cloud infrastructure. It gives you:
...
**Question not answered?** [Open a discussion](https://github.com/andrelin/synology-github-runner/discussions) or [check the full documentation](00-QUICK-START.md).
