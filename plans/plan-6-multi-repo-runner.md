...
Investigate and document how to configure a single GitHub self-hosted runner to
serve multiple repositories under a personal GitHub account (not organization).
Determine the best approach and provide clear setup instructions.
